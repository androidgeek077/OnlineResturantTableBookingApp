                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                uploadData("https://firebasestorage.googleapis.com/v0/b/mechabot-d487d.appspot.com/o/32566846_1783747771719216_5113386920709193728_n.jpg?alt=media&token=dd05209b-b72d-45bb-8ca2-cf3c8d76175f");
...
//                                });
    ...
    public void uploadData(String ImageUrl) {
        ...
        userModel = new UserModel("user" ,name, email, password, Phone, ImageUrl);
